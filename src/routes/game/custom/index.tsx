  ...
  return (
    <>
      <Panel className="mb-4">
        ...
        <h1 className="mt-1 font-display text-4xl font-bold tracking-tight text-ink">Your levels, one sitting</h1>
        <p className="mt-3 max-w-prose text-muted">
          Every student can use this. Tick the BBH chapters open on your path, pick Recognize, Gloss, or Spell, and play
          the combined list. Chapter 1 starts open. Cleared chapters show a check. This mix does not unlock or lock the
          path.
        </p>
      </Panel>
