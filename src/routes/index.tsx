    ...
    <>
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        >
          ...
          <p className="mt-1 text-sm text-primary-foreground/80">Vocabulary path, Aleph-bet, Syllables, Nouns, Article & vav, Ch. 6–11 grammar, or Ultimate. Pick from the Game menu.</p>
        </Link>
        <a
          href="#study-mode"
