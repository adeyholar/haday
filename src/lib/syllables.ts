...
export const SYLLABLE_UNITS: SyllableUnit[] = [
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "May א ה ח ע take silent shewa?", he: "שָׁמַעְתָּ", ref: "Gen 3:17", choices: ["Yes", "No — only a hateph", "No — only vocal shewa"], answer: "Yes", why: "A guttural can take silent shewa, not vocal shewa. In שָׁמַעְתָּ ayin closes מַעְ; dagesh in ת is lene." },
