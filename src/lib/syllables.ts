...
export const SYLLABLE_UNITS: SyllableUnit[] = [
  ...
  },
  {
    ...
    samples: [
      ...
      { word: "שָׁמַעְתָּ", split: "שָׁ | מַעְ | תָּ", note: "Ayin is a guttural: silent shewa is allowed; vocal shewa is not. א ה ח ע take a hateph instead of vocal shewa.", ref: "Gen 3:17" },
    ],
    verses: [
