...
export type SyllableVerse = { ref: string; he: string; en: string; hit: string; hitEn?: string; why?: string; vocabId?: string };
...
export const SYLLABLE_UNITS: SyllableUnit[] = [
  {
    ...
    samples: [
      ...
      { word: "שָׁלוֹם", split: "שָׁ | לוֹם", note: "Open ש-qamets, then a closed holem syllable.", ref: "Num 6:26" },
  ...
  },
  {
    ...
    short: "Begadkephat",
    rule:
      "The six letters ב ג ד כ פ ת can take a dagesh. After a vowel it is forte (the letter doubles, and you split through it). Write the first of the pair with shewa — no dagesh, the split already shows two letters — and that shewa closes the previous syllable. The second takes the vowel and opens the next. After a consonant — or at the start of a word unless the previous word ended in a vowel — it is lene (a hard sound, not a double). Silent shewa is a closing consonant, not a vowel: dagesh after it is lene, and you do not split (שָׁמַעְתָּ → שָׁ | מַעְ | תָּ). All gutturals cannot take dagesh, including ר.",
    samples: [
      { word: "אַתָּה", split: "אַתְ | תָּה", note: "The dagesh in ת follows a vowel, so it is forte. After the split, first ת takes shewa (no dagesh) and closes; second ת takes the vowel.", ref: "Gen 49:8" },
      { word: "הַשָּׁמַיִם", split: "הַשְׁ | שָׁ | מַ | יִם", note: "First ש takes shewa and closes הַשְׁ — no dagesh once it is split. Second ש takes qamets.", ref: "Gen 1:1" },
      { word: "אִשָּׁה", split: "אִשְׁ | שָׁה", note: "Forte in ש after hireq. First ש shewa-closes (no dagesh); second takes the vowel.", ref: "Gen 2:23" },
      { word: "כַּבֵּד", split: "כַּבְ | בֵד", note: "Forte in ב after pathach — first ב shewa-closes (no dagesh); second takes tsere.", ref: "Exod 20:12" },
      ...
      { word: "שָׁמַעְתָּ", split: "שָׁ | מַעְ | תָּ", note: "Silent shewa after short pathach closes מַעְ. That shewa is not a vowel, so dagesh in ת is lene — do not split.", ref: "Gen 3:17" },
    ],
    verses: [
      ...
      { ref: "Gen 3:17", he: "וּלְאָדָם אָמַר כִּי שָׁמַעְתָּ לְקוֹל אִשְׁתֶּךָ", en: "To the human he said, “Because you listened to the voice of your wife…”", hit: "שָׁמַעְתָּ" },
    ],
    quiz: [
      ...
      { q: "How does אַתָּה split once the ת is forte?", he: "אַתָּה", ref: "Gen 49:8", choices: ["אַתְ | תָּה", "אַ | תָּה", "אַתָּה (one slice)"], answer: "אַתְ | תָּה", why: "First ת takes shewa (no dagesh after the split) and closes; second ת takes the vowel." },
      ...
      { q: "How does הַשָּׁמַיִם split?", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["הַשְׁ | שָׁ | מַ | יִם", "הַ | שָּׁמַיִם", "הַשָּׁ | מַיִם"], answer: "הַשְׁ | שָׁ | מַ | יִם", why: "First ש takes shewa and closes — no dagesh once split. Second ש takes qamets." },
      { q: "How does אִשָּׁה split?", he: "אִשָּׁה", ref: "Gen 2:23", choices: ["אִשְׁ | שָׁה", "אִ | שָּׁה", "אִשָּׁה (one)"], answer: "אִשְׁ | שָׁה", why: "First ש shewa-closes (no dagesh); second takes the vowel." },
      { q: "How does כַּבֵּד split?", he: "כַּבֵּד", ref: "Exod 20:12", choices: ["כַּבְ | בֵד", "כַּ | בֵּד", "כַּבֵּ | ד"], answer: "כַּבְ | בֵד", why: "First ב shewa-closes (no dagesh); second takes tsere." },
      ...
      { q: "In שָׁמַעְתָּ, the dagesh in ת is…", he: "שָׁמַעְתָּ", ref: "Gen 3:17", choices: ["Lene — silent shewa is not a vowel", "Forte — split through the ת", "Mappiq"], answer: "Lene — silent shewa is not a vowel", why: "Pathach is short, so עְ is silent and closes מַעְ. Dagesh after that is lene: שָׁ | מַעְ | תָּ." },
      { q: "Which letters never take dagesh?", choices: ["All gutturals, including ר", "Begadkephat only", "Final forms only"], answer: "All gutturals, including ר", why: "א ה ח ע and ר refuse both lene and forte." },
      ...
      { q: "In Gen 1:1 הַשָּׁמַיִם, you split through ש because…", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["The dagesh is forte", "ש always starts a new word", "The article never joins a syllable"], answer: "The dagesh is forte", why: "First ש shewa-closes הַשְׁ (no dagesh after the split); second ש takes the vowel שָׁ." },
      { q: "Does ר take dagesh?", choices: ["No — no guttural does, including ר", "Yes, freely", "Only lene, never forte"], answer: "No — no guttural does, including ר", why: "All gutturals cannot take dagesh. That includes ר." },
  ...
  },
  {
    ...
    samples: [
      ...
      { word: "שָׁמַעְתָּ", split: "שָׁ | מַעְ | תָּ", note: "ע takes silent shewa (short pathach before it). Dagesh in ת is lene — silent shewa is not a vowel, so do not split the ת.", ref: "Gen 3:17" },
    ],
    verses: [
    ...
    quiz: [
      ...
      { q: "In פַּרְעֹה, the shewa under ר is…", he: "פַּרְעֹה", ref: "Exod 5:1", choices: ["Silent", "Vocal", "Hateph pathach"], answer: "Silent", why: "ר follows the shewa rules: short pathach before it, so the shewa is silent." },
      ...
      { q: "Gutturals take vocal shewa?", choices: ["No — א ה ח ע take a hateph; silent shewa is allowed", "Yes, always", "No — they cannot take any shewa"], answer: "No — א ה ח ע take a hateph; silent shewa is allowed", why: "Vocal shewa is replaced by a hateph. Silent shewa is fine (שָׁמַעְתָּ). ר is not under that hateph rule — its shewa is silent or vocal by the shewa tests." },
      { q: "People say gutturals never take shewa. The precise rule is…", he: "שָׁמַעְתָּ", ref: "Gen 3:17", choices: ["No vocal shewa (hateph instead); silent shewa is allowed", "No shewa of any kind", "Only vocal shewa, never silent"], answer: "No vocal shewa (hateph instead); silent shewa is allowed", why: "Silent shewa is not a vowel. שָׁמַעְתָּ has silent shewa under ע — the text, not the shortcut." },
      { q: "How does שָׁמַעְתָּ split?", he: "שָׁמַעְתָּ", ref: "Gen 3:17", choices: ["שָׁ | מַעְ | תָּ", "שָׁ | מַ | עְתָּ", "שָׁ | מַעְ | תּ | תָ"], answer: "שָׁ | מַעְ | תָּ", why: "Silent shewa closes מַעְ. Do not split the ת: that dagesh is lene." },
      { q: "Shewa under ר is judged by…", he: "פַּרְעֹה", ref: "Exod 5:1", choices: ["The ordinary shewa rules", "The guttural hateph rule", "Always vocal"], answer: "The ordinary shewa rules", why: "ר does not take a hateph. In פַּרְעֹה the shewa is silent because a short vowel stands before it." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "How does מוֹשִׁיעַ split?", he: "מוֹשִׁיעַ", ref: "Isa 19:20", choices: ["מוֹ | שִׁיעַ", "מוֹ | שִׁי | עַ", "מוֹשִׁיעַ (one)"], answer: "מוֹ | שִׁיעַ", why: "Two real vowels (holem, hireq-י). Furtive pathach on ע." },
      ...
      { q: "רָקִיעַ has furtive pathach on which letter?", he: "רָקִיעַ", ref: "Gen 1:6", choices: ["ע", "ר", "ק"], answer: "ע", why: "The extra pathach sits under the final ע." },
    ],
  },
  {
    id: 6,
    ...
    samples: [
      { word: "חַטָּאת", split: "חַטְ | טָאת", note: "The last א is quiescent. Forte in ט: first ט shewa-closes (no dagesh); second takes the vowel.", ref: "Ps 51:5" },
      { word: "בָּרָא", split: "בָּ | רָא", note: "Final א has no vowel — quiescent. Two open syllables.", ref: "Gen 1:1" },
      { word: "וַיַּרְא", split: "וַיְ | יַרְא", note: "Dagesh in י is forte (wayyiqtol). First י shewa-closes (no dagesh); second takes pathach. Quiet א stays in the last slice.", ref: "Gen 1:4" },
    ...
    quiz: [
      ...
      { q: "Split of חַטָּאת?", he: "חַטָּאת", ref: "Ps 51:5", choices: ["חַטְ | טָאת", "חַ | טָּאת", "חַטָּ | את"], answer: "חַטְ | טָאת", why: "First ט shewa-closes (no dagesh); second takes the vowel. Final א is quiescent." },
      ...
      { q: "How does וַיַּרְא split?", he: "וַיַּרְא", ref: "Gen 1:4", choices: ["וַיְ | יַרְא", "וַיַּרְ | א", "וַיַּרְא (one)"], answer: "וַיְ | יַרְא", why: "First י shewa-closes (no dagesh); second takes pathach. Quiet א stays in the last slice." },
      { q: "How does מָצָא split?", he: "מָצָא", choices: ["מָ | צָא", "מָצ | אָ", "מָצָא (one)"], answer: "מָ | צָא", why: "Two open slices; final א is quiet." },
      { q: "If א has a vowel under it, it is…", choices: ["A real consonant/onset for that syllable", "Always quiescent anyway", "Always a vowel letter only"], answer: "A real consonant/onset for that syllable", why: "א with a vowel starts (or fills) a slice. Quiet א has none." },
  ...
  },
  {
    ...
    samples: [
      { word: "שָׁמַיִם", split: "שָׁ | מַ | יִם", note: "Qamets, pathach, hireq — one vowel each. (True dual endings like יָדַיִם still keep ַיִם as one cluster.)", ref: "Gen 1:1" },
    ...
    quiz: [
      { q: "A syllable with the ay cluster is…", choices: ["Closed — it ends with a consonant", "Open — י is a vowel letter here", "Not a syllable"], answer: "Closed — it ends with a consonant", why: "The cluster still finishes on a consonant." },
      { q: "Split of שָׁמַיִם?", he: "שָׁמַיִם", ref: "Gen 1:1", choices: ["שָׁ | מַ | יִם", "שָׁמַ | יִם", "שָׁמַיִם (one)"], answer: "שָׁ | מַ | יִם", why: "One vowel per slice: qamets, pathach, hireq." },
      ...
      { q: "May you split inside ַיִ?", choices: ["No — keep the cluster", "Yes — י always starts a new syllable", "Only if the word is plural"], answer: "No — keep the cluster", why: "The diphthong is one unit." },
      ...
      { q: "In הַשָּׁמַיִם, after the article, the doubled ש splits as…", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["הַשְׁ | שָׁ then מַ | יִם", "הַ | שָּׁמַיִם", "הַשּׁ with dagesh still on the first ש"], answer: "הַשְׁ | שָׁ then מַ | יִם", why: "First ש takes shewa and closes — no dagesh after the split. Second takes qamets. Then pathach, then hireq." },
      ...
      { q: "The ay group is built from…", choices: ["Pathach (or similar) + י + hireq", "Two qamets vowels", "Shewa + א"], answer: "Pathach (or similar) + י + hireq", why: "That tight bundle is the diphthong." },
      { q: "The aw group is built from…", choices: ["Qamets + ו + segol (or similar)", "Holem-ו alone", "Two shewas"], answer: "Qamets + ו + segol (or similar)", why: "That bundle is the aw diphthong." },
      ...
      { q: "A diphthong syllable is closed because…", choices: ["It still ends with a consonant", "Every Hebrew syllable is closed", "י and ו are always vowels"], answer: "It still ends with a consonant", why: "The cluster’s last sound is consonantal." },
      { q: "In Gen 1:1 הַשָּׁמַיִם, how many slices after you split the forte ש?", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["Four: הַשְׁ | שָׁ | מַ | יִם", "Two: הַ | שָּׁמַיִם", "Three: הַשְׁ | שָׁ | מַיִם"], answer: "Four: הַשְׁ | שָׁ | מַ | יִם", why: "First ש shewa-closes the article (no dagesh); second takes the vowel; then מַ and יִם." },
      { q: "A dual noun is dual only when the ending holds…", he: "יָדַיִם", ref: "Prov 6:17", choices: ["The ay diphthong plus ם", "Any י-ם", "A hireq before י"], answer: "The ay diphthong plus ם", why: "Same cluster as בַּיִת. That diphthong is required. ִים without it is many, not a pair." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "Gutturals cannot take dagesh. Does that include ר?", choices: ["Yes — all gutturals, including ר", "No — ר may take dagesh", "Only forte, not lene"], answer: "Yes — all gutturals, including ר", why: "א ה ח ע and ר refuse both lene and forte." },
      { q: "Instead of vocal shewa, א ה ח ע take…", choices: ["A hateph (reduced) vowel", "Nothing — they stay vowelless", "Dagesh forte"], answer: "A hateph (reduced) vowel", why: "Gutturals excluding ר cannot take vocal shewa. Silent shewa is still allowed." },
      { q: "ר is unlike א ה ח ע in that shewa on ר…", choices: ["Follows the shewa rules, not hateph", "Takes dagesh forte freely", "Is always a hateph"], answer: "Follows the shewa rules, not hateph", why: "No dagesh on ר. Silent or vocal is the ordinary shewa test (פַּרְעֹה silent; רְאוּבֵן vocal)." },
      { q: "How does אֱלֹהִים split?", he: "אֱלֹהִים", ref: "Gen 1:1", choices: ["אֱ | לֹ | הִים", "אֱלֹ | הִים", "אֱלֹהִים (one)"], answer: "אֱ | לֹ | הִים", why: "Hateph opens; holem; then hiriq-י." },
      ...
      { q: "In אֱלֹהִים the ֱ under א is…", he: "אֱלֹהִים", ref: "Gen 1:1", choices: ["Hateph segol — a reduced vowel, open slice", "Silent shewa", "Qamets hatuf"], answer: "Hateph segol — a reduced vowel, open slice", why: "א ה ח ע take a hateph, not vocal shewa." },
      { q: "Why not put dagesh in עֶבֶד’s ע?", he: "עֶבֶד", ref: "Josh 1:1", choices: ["All gutturals refuse dagesh, including this ע", "ע never starts a word", "The word has no vowels"], answer: "All gutturals refuse dagesh, including this ע", why: "ע is a guttural. ר is in that same ‘no dagesh’ group." },
