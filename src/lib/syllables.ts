...
export const SYLLABLE_UNITS: SyllableUnit[] = [
  ...
  },
  {
    ...
    samples: [
      ...
      { word: "הַשָּׁמַיִם", split: "הַשְׁ | שָׁ | מַ | יִם", note: "First shin takes shewa and closes הַשְׁ — no dagesh once it is split. Second shin takes qamets.", ref: "Gen 1:1" },
      { word: "אִשָּׁה", split: "אִשְׁ | שָׁה", note: "Forte in ש after hireq. First shin shewa-closes (no dagesh); second takes the vowel.", ref: "Gen 2:23" },
    ...
    quiz: [
      ...
      { q: "How does הַשָּׁמַיִם split?", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["הַשְׁ | שָׁ | מַ | יִם", "הַ | שָּׁמַיִם", "הַשָּׁ | מַיִם"], answer: "הַשְׁ | שָׁ | מַ | יִם", why: "First shin takes shewa and closes — no dagesh once split. Second shin takes qamets." },
      { q: "How does אִשָּׁה split?", he: "אִשָּׁה", ref: "Gen 2:23", choices: ["אִשְׁ | שָׁה", "אִ | שָּׁה", "אִשָּׁה (one)"], answer: "אִשְׁ | שָׁה", why: "First shin shewa-closes (no dagesh); second takes the vowel." },
      ...
      { q: "In שָׁמַעְתָּ, the dagesh in ת is…", he: "שָׁמַעְתָּ", ref: "Gen 3:17", choices: ["Lene — silent shewa is not a vowel", "Forte — split through the tav", "Mappiq"], answer: "Lene — silent shewa is not a vowel", why: "Pathach is short, so עְ is silent and closes מַעְ. Dagesh after that is lene: שָׁ | מַעְ | תָּ." },
      ...
      { q: "In Gen 1:1 הַשָּׁמַיִם, you split through ש because…", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["The dagesh is forte", "Shin always starts a new word", "The article never joins a syllable"], answer: "The dagesh is forte", why: "First shin shewa-closes הַשְׁ (no dagesh after the split); second shin takes the vowel שָׁ." },
      { q: "Does ר take dagesh?", choices: ["No — no guttural does, including resh", "Yes, freely", "Only lene, never forte"], answer: "No — no guttural does, including resh", why: "All gutturals cannot take dagesh. That includes ר." },
  ...
  },
  {
    ...
    samples: [
      ...
      { word: "שָׁמַעְתָּ", split: "שָׁ | מַעְ | תָּ", note: "Ayin takes silent shewa (short pathach before it). Dagesh in ת is lene — silent shewa is not a vowel, so do not split the tav.", ref: "Gen 3:17" },
    ],
    verses: [
  ...
  },
  {
    ...
    samples: [
      ...
      { word: "וַיַּרְא", split: "וַיְ | יַרְא", note: "Dagesh in י is forte (wayyiqtol). First yod shewa-closes (no dagesh); second takes pathach. Quiet א stays in the last slice.", ref: "Gen 1:4" },
    ...
    quiz: [
      ...
      { q: "How does וַיַּרְא split?", he: "וַיַּרְא", ref: "Gen 1:4", choices: ["וַיְ | יַרְא", "וַיַּרְ | א", "וַיַּרְא (one)"], answer: "וַיְ | יַרְא", why: "First yod shewa-closes (no dagesh); second takes pathach. Quiet א stays in the last slice." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "In הַשָּׁמַיִם, after the article, the doubled shin splits as…", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["הַשְׁ | שָׁ then מַ | יִם", "הַ | שָּׁמַיִם", "הַשּׁ with dagesh still on the first shin"], answer: "הַשְׁ | שָׁ then מַ | יִם", why: "First shin takes shewa and closes — no dagesh after the split. Second takes qamets. Then pathach, then hireq." },
      ...
      { q: "In Gen 1:1 הַשָּׁמַיִם, how many slices after you split the forte shin?", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["Four: הַשְׁ | שָׁ | מַ | יִם", "Two: הַ | שָּׁמַיִם", "Three: הַשְׁ | שָׁ | מַיִם"], answer: "Four: הַשְׁ | שָׁ | מַ | יִם", why: "First shin shewa-closes the article (no dagesh); second takes the vowel; then מַ and יִם." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "Why not put dagesh in עֶבֶד’s ע?", he: "עֶבֶד", ref: "Josh 1:1", choices: ["All gutturals refuse dagesh, including this ayin", "Ayin never starts a word", "The word has no vowels"], answer: "All gutturals refuse dagesh, including this ayin", why: "ע is a guttural. Resh is in that same ‘no dagesh’ group." },
