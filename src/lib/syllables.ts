...
export const SYLLABLE_UNITS: SyllableUnit[] = [
  ...
  },
  {
    ...
    short: "Begadkephat",
    rule:
      "The six letters ב ג ד כ פ ת can take a dagesh. After a vowel it is forte (the letter doubles, and you split through it). The first of the doubled pair takes shewa and closes the previous syllable; the second takes the vowel and opens the next. After a consonant — or at the start of a word unless the previous word ended in a vowel — it is lene (a hard sound, not a double). Gutturals and ר never take dagesh.",
    samples: [
      { word: "אַתָּה", split: "אַתּ | תָּה", note: "The dagesh in ת follows a vowel (pathach), so it is forte. First ת takes shewa and closes; second ת takes the vowel.", ref: "Gen 49:8" },
      { word: "הַשָּׁמַיִם", split: "הַשּׁ | שָׁ | מַ | יִם", note: "Forte in ש after the article: first shin takes shewa and closes הַשּׁ; second shin takes qamets.", ref: "Gen 1:1" },
      { word: "אִשָּׁה", split: "אִשּׁ | שָׁה", note: "Forte in ש after hireq. First shin shewa-closes; second takes the vowel.", ref: "Gen 2:23" },
      { word: "כַּבֵּד", split: "כַּבּ | בֵד", note: "Forte in ב after pathach — first ב shewa-closes; second takes tsere.", ref: "Exod 20:12" },
    ...
    quiz: [
      ...
      { q: "How does אַתָּה split once the ת is forte?", he: "אַתָּה", ref: "Gen 49:8", choices: ["אַתּ | תָּה", "אַ | תָּה", "אַתָּה (one slice)"], answer: "אַתּ | תָּה", why: "First ת takes shewa and closes; second ת takes the vowel." },
      ...
      { q: "How does הַשָּׁמַיִם split?", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["הַשּׁ | שָׁ | מַ | יִם", "הַ | שָּׁמַיִם", "הַשָּׁ | מַיִם"], answer: "הַשּׁ | שָׁ | מַ | יִם", why: "First shin takes shewa and closes the article; second shin takes qamets." },
      { q: "How does אִשָּׁה split?", he: "אִשָּׁה", ref: "Gen 2:23", choices: ["אִשּׁ | שָׁה", "אִ | שָּׁה", "אִשָּׁה (one)"], answer: "אִשּׁ | שָׁה", why: "First shin shewa-closes; second takes the vowel." },
      { q: "How does כַּבֵּד split?", he: "כַּבֵּד", ref: "Exod 20:12", choices: ["כַּבּ | בֵד", "כַּ | בֵּד", "כַּבֵּ | ד"], answer: "כַּבּ | בֵד", why: "First ב shewa-closes; second takes tsere." },
      ...
      { q: "In Gen 1:1 הַשָּׁמַיִם, you split through ש because…", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["The dagesh is forte", "Shin always starts a new word", "The article never joins a syllable"], answer: "The dagesh is forte", why: "First shin shewa-closes הַשּׁ; second shin takes the vowel שָׁ." },
  ...
  },
  {
    ...
    samples: [
      { word: "חַטָּאת", split: "חַטּ | טָאת", note: "The last א is quiescent. Forte in ט: first ט shewa-closes; second takes the vowel.", ref: "Ps 51:5" },
      { word: "בָּרָא", split: "בָּ | רָא", note: "Final א has no vowel — quiescent. Two open syllables.", ref: "Gen 1:1" },
      { word: "וַיַּרְא", split: "וַיּ | יַרְא", note: "Dagesh in י is forte (wayyiqtol). First yod shewa-closes; second takes pathach. Quiet א stays in the last slice.", ref: "Gen 1:4" },
    ...
    quiz: [
      ...
      { q: "Split of חַטָּאת?", he: "חַטָּאת", ref: "Ps 51:5", choices: ["חַטּ | טָאת", "חַ | טָּאת", "חַטָּ | את"], answer: "חַטּ | טָאת", why: "First ט shewa-closes; second takes the vowel. Final א is quiescent." },
      ...
      { q: "How does וַיַּרְא split?", he: "וַיַּרְא", ref: "Gen 1:4", choices: ["וַיּ | יַרְא", "וַיַּרְ | א", "וַיַּרְא (one)"], answer: "וַיּ | יַרְא", why: "First yod shewa-closes; second takes pathach. Quiet א stays in the last slice." },
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "In הַשָּׁמַיִם, after the article, the doubled shin splits as…", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["הַשּׁ | שָׁ then מַ | יִם", "הַ | שָּׁמַיִם", "הַשְׁ as one shin with no double"], answer: "הַשּׁ | שָׁ then מַ | יִם", why: "First shin takes shewa and closes; second takes qamets. Then pathach, then hireq." },
      ...
      { q: "In Gen 1:1 הַשָּׁמַיִם, how many slices after you split the forte shin?", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["Four: הַשּׁ | שָׁ | מַ | יִם", "Two: הַ | שָּׁמַיִם", "Three: הַשְׁ | שָׁ | מַיִם"], answer: "Four: הַשּׁ | שָׁ | מַ | יִם", why: "First shin shewa-closes the article; second takes the vowel; then מַ and יִם." },
