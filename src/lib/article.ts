...
export const ARTICLE_UNITS: ArticleUnit[] = [
  {
    ...
    samples: [
      ...
      { word: "הַמֶּלֶךְ", gloss: "the king", tag: "article", note: "הַ plus dagesh in מ. That is the everyday article.", ref: "Isa 6:1" },
      ...
      { word: "הָאָרֶץ", gloss: "the land / the earth", tag: "article", note: "Article is present. The vowel under ה is qamets here — that spelling is a later unit.", ref: "Gen 1:1" },
    ],
    verses: [
    ...
    quiz: [
      ...
      { q: "הַמֶּלֶךְ is…", he: "הַמֶּלֶךְ", choices: ["The king — article plus the noun", "A king — indefinite", "Kings — plural"], answer: "The king — article plus the noun", why: "See the prefixed ה and the dagesh in מ." },
      ...
      { q: "In Ps 24:8, הַכָּבוֹד is…", he: "הַכָּבוֹד", ref: "Ps 24:8", choices: ["Definite — “the glory”", "Indefinite", "A verb"], answer: "Definite — “the glory”", why: "Article הַ plus dagesh in כ." },
      ...
      { q: "English “the” is the usual gloss of…", he: "הַ", choices: ["The prefixed article הַ", "The conjunction וְ", "The dual ending"], answer: "The prefixed article הַ", why: "Class particle: הַ “the.”" },
  ...
  },
  {
    ...
    samples: [
      { word: "הַמֶּלֶךְ", gloss: "the king", tag: "הַ + dagesh", note: "Pathach under ה. Dagesh forte in מ.", ref: "Isa 6:1" },
      { word: "הַיָּם", gloss: "the sea", tag: "הַ + dagesh", note: "י takes the dagesh. Citation lemma is still יָם.", ref: "Exod 14:21" },
      { word: "הַמִּזְבֵּחַ", gloss: "the altar", tag: "הַ + dagesh", note: "Dagesh in מ. The noun’s own dagesh in ב is separate.", ref: "Lev 1:7" },
      { word: "הַבַּיִת", gloss: "the house", tag: "begadkephat", note: "ב already had dagesh lene as בַּיִת. With the article that dagesh is forte." },
      { word: "הַתּוֹרָה", gloss: "the instruction", tag: "begadkephat", note: "ת takes the article’s dagesh.", ref: "Josh 1:8" },
      { word: "הַשַּׁעַר", gloss: "the gate", tag: "הַ + dagesh", note: "ש takes dagesh after הַ.", ref: "Ruth 4:1" },
    ],
    verses: [
      { ref: "Ps 24:8", he: "מִי זֶה מֶלֶךְ הַכָּבוֹד יְהוָה עִזּוּז וְגִבּוֹר", en: "Who is this king of glory? YHWH, strong and mighty.", hit: "הַכָּבוֹד", hitEn: "glory", vocabId: "kavod" },
    ...
    quiz: [
      { q: "The ordinary article is…", choices: ["הַ plus dagesh forte in the first letter of the noun", "הָ plus no dagesh always", "וְ plus shewa"], answer: "הַ plus dagesh forte in the first letter of the noun", why: "Pathach under ה, doubling on the next consonant." },
      { q: "In הַמֶּלֶךְ the dagesh in מ is…", he: "הַמֶּלֶךְ", choices: ["Dagesh forte from the article", "Dagesh lene only", "A שׁ-dot"], answer: "Dagesh forte from the article", why: "The article’s doubling sits in the first letter." },
      ...
      { q: "When the article is added to בַּיִת, the dagesh in ב…", he: "הַבַּיִת", choices: ["Is now dagesh forte (it was lene on the bare noun)", "Disappears", "Moves to the ה"], answer: "Is now dagesh forte (it was lene on the bare noun)", why: "Same mark, new job. Begadkephat with the article." },
      { q: "הַתּוֹרָה shows the article on a begadkephat letter because…", he: "הַתּוֹרָה", ref: "Josh 1:8", choices: ["ת has dagesh after הַ", "ה has qamets", "There is no dagesh"], answer: "ת has dagesh after הַ", why: "Regular article. Pathach + dagesh." },
      { q: "הַכָּבוֹד in Ps 24:8 is…", he: "הַכָּבוֹד", ref: "Ps 24:8", choices: ["The glory — הַ + dagesh in כ", "A glory — no article", "Kings"], answer: "The glory — הַ + dagesh in כ", why: "כ is begadkephat. The dagesh here is forte from the article." },
      ...
      { q: "הַמִּזְבֵּחַ is…", he: "הַמִּזְבֵּחַ", ref: "Lev 1:7", choices: ["The altar — article on מִזְבֵּחַ", "An altar", "Altars"], answer: "The altar — article on מִזְבֵּחַ", why: "Dagesh in מ. Look it up as מִזְבֵּחַ." },
      { q: "הַשַּׁעַר is…", he: "הַשַּׁעַר", ref: "Ruth 4:1", choices: ["The gate — הַ + dagesh in ש", "Heaven", "A verb"], answer: "The gate — הַ + dagesh in ש", why: "Regular article on שַׁעַר." },
      { q: "הַזָּהָב means…", he: "הַזָּהָב", ref: "Gen 41:42", choices: ["The gold", "Gold (indefinite)", "Silver"], answer: "The gold", why: "Article plus זָהָב. Dagesh in ז." },
      ...
      { q: "הַדֶּרֶךְ (the road) keeps a dagesh in ד because…", he: "הַדֶּרֶךְ", choices: ["ד is begadkephat and takes the article’s forte", "ד is a guttural", "The article is הֶ"], answer: "ד is begadkephat and takes the article’s forte", why: "Regular article. Pathach stays." },
      ...
      { q: "Does the regular article change the consonants of the noun?", choices: ["No — it prefixes הַ and doubles the first letter", "Yes — the first letter is replaced", "Yes — a ו is added"], answer: "No — it prefixes הַ and doubles the first letter", why: "The noun is still there. Read past the prefix." },
    ],
  },
  {
    id: 3,
    ...
    short: "הָ, הַ, הֶ",
    rule:
      "All gutturals — א ה ח ע — and also ר cannot take dagesh, lene or forte. The article still wants to double the first letter. When that doubling is refused, the article is spelled in three ways. With א, ע, or ר the pathach lengthens to qamets: הָאִישׁ, הָעִיר, הָרֹאשׁ. That is compensatory lengthening. With ה or ח the pathach usually stays: הַהֵיכָל, הַחֶרֶב. That is virtual doubling — the dagesh is missing, the vowel does not lengthen. Before unaccented הָ, חָ, or עָ (and sometimes accented חָ) the article is הֶ with no dagesh: הֶחָכָם, הֶעָנָן, הֶהָרִים. Name the first letter, then name the vowel under ה.",
    samples: [
      { word: "הָאִישׁ", gloss: "the man", tag: "compensatory · א", note: "א refuses dagesh. Pathach → qamets. הָ." },
      { word: "הָעִיר", gloss: "the city", tag: "compensatory · ע", note: "ע refuses dagesh. הָ." },
      { word: "הָרֹאשׁ", gloss: "the head", tag: "compensatory · ר", note: "ר refuses dagesh like a guttural. הָ." },
      { word: "הַהֵיכָל", gloss: "the temple", tag: "virtual · ה", note: "ה refuses dagesh but pathach stays. הַ.", ref: "Isa 6:1" },
      { word: "הַחֶרֶב", gloss: "the sword", tag: "virtual · ח", note: "ח refuses dagesh; pathach stays. הַחֶרֶב, not הָחֶרֶב.", ref: "Gen 3:24" },
    ...
    quiz: [
      { q: "Gutturals and ר cannot take…", choices: ["Dagesh — lene or forte", "Any vowel", "The article at all"], answer: "Dagesh — lene or forte", why: "א ה ח ע and ר refuse the article’s doubling." },
      ...
      { q: "הָאִישׁ is…", he: "הָאִישׁ", choices: ["Article with compensatory qamets (א)", "Regular הַ + dagesh", "Seghol article"], answer: "Article with compensatory qamets (א)", why: "א cannot take dagesh. הָ." },
      { q: "הָאֵשׁ is…", he: "הָאֵשׁ", ref: "Gen 22:6", choices: ["The fire — compensatory הָ on אֵשׁ", "Indefinite fire", "The woman"], answer: "The fire — compensatory הָ on אֵשׁ", why: "א. Pathach has become qamets." },
      { q: "Virtual doubling means…", choices: ["Dagesh is refused but the pathach stays: הַ", "The article is missing", "The noun is dual"], answer: "Dagesh is refused but the pathach stays: הַ", why: "ה and ח usually do this." },
      { q: "הַהֵיכָל is virtual doubling because…", he: "הַהֵיכָל", ref: "Isa 6:1", choices: ["The noun begins with ה; pathach stays, no dagesh", "א caused qamets", "It is the conjunction"], answer: "The noun begins with ה; pathach stays, no dagesh", why: "הַ not הָ. Temple." },
      { q: "הַחֶרֶב is…", he: "הַחֶרֶב", ref: "Gen 3:24", choices: ["Virtual doubling — הַ before ח", "Compensatory הָ", "No article"], answer: "Virtual doubling — הַ before ח", why: "Pathach, not qamets. ח refuses dagesh." },
      { q: "The irregular seghol article הֶ appears before…", choices: ["Unaccented הָ, חָ, or עָ", "Any guttural", "Labials ב מ פ"], answer: "Unaccented הָ, חָ, or עָ", why: "הֶחָכָם, הֶעָנָן, הֶהָרִים. ח with qamets may be accented and still take הֶ." },
      { q: "הֶעָנָן is…", he: "הֶעָנָן", ref: "Exod 13:22", choices: ["The cloud — seghol article before עָ", "Regular הַ + dagesh", "Compensatory הָ"], answer: "The cloud — seghol article before עָ", why: "Look at the vowel under ה: seghol." },
      ...
      { q: "הָאָדָם in Gen 2:7 is…", he: "הָאָדָם", ref: "Gen 2:7", choices: ["The man — compensatory on א", "Virtual doubling", "No article"], answer: "The man — compensatory on א", why: "הָ + אָדָם." },
      { q: "How do you tell compensatory from virtual doubling?", choices: ["Compensatory has הָ (qamets); virtual keeps הַ (pathach)", "Virtual always has dagesh", "They are spelled the same"], answer: "Compensatory has הָ (qamets); virtual keeps הַ (pathach)", why: "Name the vowel under ה." },
      { q: "הָעִיר begins with ע, so the article is…", he: "הָעִיר", choices: ["הָ — compensatory", "הַ — virtual", "הֶ — seghol"], answer: "הָ — compensatory", why: "ע is in the א ע ר set." },
      { q: "ר with the article behaves like…", he: "הָרֹאשׁ", choices: ["א and ע — compensatory הָ", "ה and ח — virtual הַ", "A begadkephat with dagesh"], answer: "א and ע — compensatory הָ", why: "ר refuses dagesh. הָרֹאשׁ." },
      { q: "Which is virtual doubling?", choices: ["הַחֶרֶב", "הָאִישׁ", "הֶעָנָן"], answer: "הַחֶרֶב", why: "Pathach, ח, no dagesh. Not qamets, not seghol." },
    ],
  },
  {
    id: 4,
    ...
    samples: [
      { word: "הַיְלָדִים", gloss: "the boys", tag: "dagesh dropped · יְ", note: "י + vocal shewa. Article הַ, no dagesh in י.", ref: "1 Kgs 12:8" },
      { word: "הַמְרַגְּלִים", gloss: "the spies", tag: "dagesh dropped · מְ", note: "מ + vocal shewa. Pathach stays.", ref: "Josh 6:22" },
      ...
      { word: "הָעָם", gloss: "the people", tag: "noun vowel moves", note: "עַם → הָעָם. ע: compensatory, and pathach of the noun lengthens.", ref: "Exod 13:22" },
      { word: "הַגָּן", gloss: "the garden", tag: "noun vowel moves", note: "גַּן → הַגָּן. ג can take dagesh, so the article is regular הַ; the noun’s own pathach becomes qamets.", ref: "Gen 2:10" },
    ...
    quiz: [
      { q: "הַיְלָדִים has no dagesh in י because…", he: "הַיְלָדִים", ref: "1 Kgs 12:8", choices: ["י with vocal shewa often drops the article’s dagesh", "י is a guttural", "The article is missing"], answer: "י with vocal shewa often drops the article’s dagesh", why: "הַיְ not הַיּ. Pathach stays." },
      { q: "הַמְרַגְּלִים is…", he: "הַמְרַגְּלִים", ref: "Josh 6:22", choices: ["The spies — הַ, dagesh dropped under מְ", "Compensatory הָ", "Indefinite"], answer: "The spies — הַ, dagesh dropped under מְ", why: "מ + vocal shewa. Same family as הַיְלָדִים." },
      { q: "The sqnmlwy loss of dagesh happens when…", choices: ["A letter in that set would have dagesh forte plus vocal shewa", "Any noun begins with מ", "The noun is feminine"], answer: "A letter in that set would have dagesh forte plus vocal shewa", why: "s-type letters plus q n m l w y. Not every מ." },
      { q: "אֶרֶץ with the article is…", he: "הָאָרֶץ", ref: "Gen 1:1", choices: ["הָאָרֶץ — first vowel of the noun also moves to qamets", "הַאֶרֶץ with dagesh", "הֶאֶרֶץ"], answer: "הָאָרֶץ — first vowel of the noun also moves to qamets", why: "Learn the pair. א: compensatory, and אֶ → אָ." },
      { q: "עַם with the article is…", he: "הָעָם", choices: ["הָעָם", "הַעַם", "הֶעַם"], answer: "הָעָם", why: "ע compensatory, and the noun’s pathach lengthens." },
      { q: "גַּן with the article is…", he: "הַגָּן", ref: "Gen 2:10", choices: ["הַגָּן — regular הַ + dagesh, noun vowel → qamets", "הָגַן", "הֶגַן"], answer: "הַגָּן — regular הַ + dagesh, noun vowel → qamets", why: "ג can take dagesh. The change is in the noun, not the article vowel." },
      ...
      { q: "הֶהָרִים (the mountains) uses seghol because…", he: "הֶהָרִים", ref: "Deut 12:2", choices: ["The article sits before unaccented הָ", "Mountains are dual", "ג refused dagesh"], answer: "The article sits before unaccented הָ", why: "Same seghol rule as הֶעָנָן. Singular was הָהָר." },
      ...
      { q: "In Gen 1:1 הָאָרֶץ you should see…", he: "הָאָרֶץ", ref: "Gen 1:1", choices: ["Article (compensatory) plus a noun that changed its first vowel", "No article — a name", "Virtual doubling on ג"], answer: "Article (compensatory) plus a noun that changed its first vowel", why: "Two facts, one word." },
      { q: "Does every י drop the article’s dagesh?", choices: ["No — mainly י with vocal shewa (יְ)", "Yes, always", "Only in the dual"], answer: "No — mainly י with vocal shewa (יְ)", why: "הַיָּם keeps dagesh. הַיְלָדִים drops it." },
      { q: "הַיָּם vs הַיְלָדִים. What is different?", choices: ["הַיָּם has dagesh in י; הַיְלָדִים has vocal shewa and no dagesh", "Only the gloss", "One is a verb"], answer: "הַיָּם has dagesh in י; הַיְלָדִים has vocal shewa and no dagesh", why: "Same prefix letter, two spellings. Name the vowel on י." },
      ...
      { q: "Which keeps regular הַ + dagesh and still changes the noun vowel?", choices: ["הַגָּן", "הָאָרֶץ", "הָעָם"], answer: "הַגָּן", why: "ג takes dagesh. א and ע also force compensatory הָ." },
      { q: "Pathach under the article, no dagesh, י with shewa: you are looking at…", he: "הַיְלָדִים", choices: ["Tה dropped-dagesh spelling, not a missing article", "Compensatory lengthening", "The conjunction וְ"], answer: "Tה dropped-dagesh spelling, not a missing article", why: "Still הַ. Still “the.”" },
    ],
  },
  {
    id: 5,
    ...
    samples: [
      ...
      { word: "וּמֶלֶךְ", gloss: "and a king", tag: "bump · מ", note: "Labial מ. Shureq וּ.", ref: "2 Kgs 3:9" },
      { word: "וּבֵיתוֹ", gloss: "and his house", tag: "bump · ב", note: "ב is a labial. Dagesh lene drops: וּב, not וּבּ.", ref: "Exod 1:1" },
      { word: "וִיהוּדָה", gloss: "and Judah", tag: "יְ contracts", note: "יְ + וְ → וִי.", ref: "1 Sam 18:16" },
      { word: "וֶאֱמֶת", gloss: "and truth", tag: "hateph match", note: "Hateph seghol on א → seghol on ו.", ref: "Exod 34:6" },
      { word: "וֵאלֹהִים", gloss: "and God", tag: "special", note: "Not וֶאֱלֹהִים. Tsere, and the hateph on א is gone.", ref: "Gen 50:24" },
    ...
    quiz: [
      ...
      { q: "The “bump” letters that take וּ are…", choices: ["ב, מ, פ", "א, ע, ר", "ה, ח"], answer: "ב, מ, פ", why: "Labials. Bump = ב, מ, פ." },
      { q: "וּמֶלֶךְ uses shureq because…", he: "וּמֶלֶךְ", ref: "2 Kgs 3:9", choices: ["מ is a bump letter", "מ is a guttural", "It is a dual"], answer: "מ is a bump letter", why: "מֶלֶךְ + וְ → וּמֶלֶךְ." },
      { q: "In וּבֵיתוֹ the ב has no dagesh lene because…", he: "וּבֵיתוֹ", ref: "Exod 1:1", choices: ["A prefix sits before it, so begadkephat loses lene", "ב never takes dagesh", "It is dagesh forte instead"], answer: "A prefix sits before it, so begadkephat loses lene", why: "בַּיִת vs וּבַיִת. The bump shureq is the prefix." },
      ...
      { q: "יְ + וְ becomes…", he: "וִיהוּדָה", ref: "1 Sam 18:16", choices: ["וִי (hireq-י), as in וִיהוּדָה", "וּיְ", "וְיְ"], answer: "וִי (hireq-י), as in וִיהוּדָה", why: "The two shewas contract. Judah." },
      { q: "Before a hateph vowel, ו takes…", choices: ["The matching short vowel (וַ וֶ וָ)", "Always shewa", "Always shureq"], answer: "The matching short vowel (וַ וֶ וָ)", why: "חֲ → וַחֲ, אֱ → וֶאֱ, חֳ → וָחֳ." },
      { q: "וֶאֱמֶת is…", he: "וֶאֱמֶת", ref: "Exod 34:6", choices: ["And truth — ו matches hateph seghol", "Bump shureq", "The article"], answer: "And truth — ו matches hateph seghol", why: "אֱמֶת + וְ → וֶאֱמֶת." },
      ...
      { q: "וָבֹהוּ in Gen 1:2 uses qamets because…", he: "וָבֹהוּ", ref: "Gen 1:2", choices: ["Monosyllabic / initially accented words often take וָ", "ב is a guttural", "It is the article"], answer: "Monosyllabic / initially accented words often take וָ", why: "תֹהוּ וָבֹהוּ. Same family as וָלֶחֶם, וָצֹאן." },
      { q: "In Gen 24:35, וּבָקָר vs וְכֶסֶף. Why the different vowels?", he: "וּבָקָר", ref: "Gen 24:35", choices: ["ב is bump (וּ); כ is not (וְ)", "One is the article", "Both should be shewa"], answer: "ב is bump (וּ); כ is not (וְ)", why: "Same verse teaches the split: וּבָקָר וְכֶסֶף וְזָהָב." },
      { q: "When you see an initial ו, you should expect…", choices: ["The conjunction, whatever the vowel under it", "A root that begins with ו", "The article"], answer: "The conjunction, whatever the vowel under it", why: "Roots with initial ו are vanishingly rare. Name it “and / but / also.”" },
      ...
      { q: "Does ו swallow the article the way some prepositions do?", choices: ["No — וְהָאָרֶץ keeps both prefixes", "Yes — the ה always drops", "Only in the dual"], answer: "No — וְהָאָרֶץ keeps both prefixes", why: "Gen 1:2 וְהָאָרֶץ. ו then article then noun." },
  ...
  },
  {
    ...
    rule:
      "On a living line, name every prefix, then the noun. Article and ו can stack: וְהָאָרֶץ is “and the earth.” The article can taste like “this/that” (הַיּוֹם this day / today), like a vocative (הַמֶּלֶךְ O king), or like a superlative in a tight pair (the good = the best). Hebrew still has no “a”; אֶחָד may mean “one” or “a certain.” When inseparable prepositions arrive in the next chapter, the ה of the article often drops and its vowel (and dagesh) sit on the preposition — לָאוֹר is לְ + הַ + אוֹר. ו never does that. Strip prefixes, restore the singular, look it up.",
    samples: [
      { word: "וְהָאָרֶץ", gloss: "and the earth", tag: "ו + article", note: "Both prefixes stay. Gen 1:2 opens on this stack.", ref: "Gen 1:2" },
      ...
      { word: "לָאוֹר", gloss: "to the light", tag: "preposition + article (preview)", note: "ה of הַ has dropped; qamets on ל is the article’s compensatory vowel. Next chapter owns the rule. Meet it in Gen 1:5.", ref: "Gen 1:5" },
    ...
    quiz: [
      ...
      { q: "לָאוֹר in Gen 1:5 is…", he: "לָאוֹר", ref: "Gen 1:5", choices: ["לְ + הַ + אוֹר — the ה of the article has dropped", "The conjunction + light", "Indefinite “to a light”"], answer: "לְ + הַ + אוֹר — the ה of the article has dropped", why: "Qamets on ל is the article’s compensatory vowel. Prepositions own this fully in the next chapter." },
      { q: "Does ו drop the ה of the article?", choices: ["No — וְהָאָרֶץ keeps the ה", "Yes, always", "Only before א"], answer: "No — וְהָאָרֶץ keeps the ה", why: "Prepositions may swallow הַ. ו does not." },
      { q: "הַשָּׁמַיִם in Gen 1:1 is…", he: "הַשָּׁמַיִם", ref: "Gen 1:1", choices: ["Regular article הַ + dagesh on the special dual “heaven”", "Compensatory הָ", "No article"], answer: "Regular article הַ + dagesh on the special dual “heaven”", why: "ש takes dagesh. The dual shape is from the nouns chapter." },
      ...
      { q: "הַדְּבָרִים in Deut 6:6 is…", he: "הַדְּבָרִים", ref: "Deut 6:6", choices: ["The words — article + masculine plural", "A dual of word", "Indefinite"], answer: "The words — article + masculine plural", why: "הַ + dagesh in ד + ִים. Nouns plus this prefix on one verse." },
      { q: "Best first move on a prefixed noun…", choices: ["Name the prefix(es), then restore the singular to look up", "Guess from English word order", "Ignore the vowels under ה and ו"], answer: "Name the prefix(es), then restore the singular to look up", why: "Article, ו, or both. Then the noun you already know." },
      { q: "וָבֹהוּ beside וְהָאָרֶץ in Gen 1:2 shows…", he: "וָבֹהוּ", ref: "Gen 1:2", choices: ["Two ו spellings in one verse: default/stack vs qamets on a short word", "Two articles", "A dual"], answer: "Two ו spellings in one verse: default/stack vs qamets on a short word", why: "וְהָאָרֶץ … תֹהוּ וָבֹהוּ." },
      ...
      { q: "The course often reads…", choices: ["Nouns together with the article and ו", "Only the article spelling", "Only names"], answer: "Nouns together with the article and ו", why: "Study can group them. Games stay as their own paths." },
      { q: "הַיַּבָּשָׁה in Jonah 1:9 is…", he: "הַיַּבָּשָׁה", ref: "Jonah 1:9", choices: ["The dry land — regular article, dagesh in י", "Compensatory on ע", "No article"], answer: "The dry land — regular article, dagesh in י", why: "הַ + יַבָּשָׁה. Same sea-and-dry-land pair as Genesis 1." },
      { q: "After you name הַ or וְ, the next job is…", choices: ["Read the noun’s ending (gender and number) and look up the singular", "Stop — prefixes are the whole word", "Always add “a” in English"], answer: "Read the noun’s ending (gender and number) and look up the singular", why: "Name the prefix, then the noun ending, then look up the singular." },
    ],
  },
];
