...
export const ARTICLE_UNITS: ArticleUnit[] = [
  ...
  },
  {
    ...
    quiz: [
      ...
      { q: "הַדְּבָרִים in Deut 6:6 is…", he: "הַדְּבָרִים", ref: "Deut 6:6", choices: ["The words — article + masculine plural", "A dual of word", "Indefinite"], answer: "The words — article + masculine plural", why: "הַ + dagesh in ד + ִים. Nouns chapter plus this chapter." },
      ...
      { q: "Week 3 of the course reads…", choices: ["Chapter 4 (nouns) and chapter 5 (article and ו) together", "Only chapter 5", "Chapters 6 and 7"], answer: "Chapter 4 (nouns) and chapter 5 (article and ו) together", why: "Study set is both. Games stay chapter by chapter." },
