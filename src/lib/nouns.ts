...
export type NounVerse = { ref: string; he: string; en: string; hit: string; hitEn?: string; why?: string; vocabId?: string };
...
export const NOUN_UNITS: NounUnit[] = [
  {
    ...
    quiz: [
      ...
      { q: "Where do you read gender and number?", choices: ["Off the ending", "Only from the lexicon", "From the first letter"], answer: "Off the ending", why: "That is the skill of this topic: see the ending, name the form." },
