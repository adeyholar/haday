...
| **Game** | BBH path Ch. 1–19, Custom mix of open chapters (every student), Aleph-bet, Syllables, Nouns, Article & vav, then grammar **topics** by name (Prepositions, Adjectives, Pronouns, Existence & nouns, Construct nouns, Numbers — original notes, not textbook chapter labels), Ultimate Challenge | Stages and grammar units unlock in order. **90%** to clear and open the next. Custom mix reviews open levels in one sitting. Citation form only (יָם, not בַּיָּם). Recognize uses close traps (look-alike / same family), not giveaways. |
