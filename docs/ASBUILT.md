...
| Tanakh cards | `/finder` hub + `/finder/deck` flashcards. Signed-in learners deal N forms of a grammar (construct, qal perfect, shewa…). Flip, then open the verse in Listen/Read. |
