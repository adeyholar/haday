...
| Tanakh finder | Owner-only `/admin/query`. Typed grammar names (hatuf, shewa, 3ms, PL, …) over a Masoretic index. Results deal as a tap-through card deck with verse text. |
