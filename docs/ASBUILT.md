...
| **Game** | BBH path Ch. 1–19, Custom mix of open chapters (every student), Aleph-bet, Syllables, Nouns, Article & vav, then **each** grammar chapter on its own (Ch. 6 Prepositions, Ch. 7 Adjectives, Ch. 8 Pronouns, Ch. 9 Existence & nouns, Ch. 10 Construct nouns, Ch. 11 Numbers), Ultimate Challenge | Stages and grammar units unlock in order. **90%** to clear and open the next. Custom mix reviews open levels in one sitting. Citation form only (יָם, not בַּיָּם). Recognize uses close traps (look-alike / same family), not giveaways. |
